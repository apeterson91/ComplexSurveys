 ...
 * Predict the total number of murders in the statte using the Poisson 
...
6. Using the same data as in Section 2.5.4, create an ordinal blood pressure
...
fruit or vegetables per day (`X_FV5RV`), binge drinking of alcohol 
