...
statistics more broadly. This write-up will reflect my understanding of the
...
grid_of_ns <- expand.grid(
  n_1 = seq(1, 100, 25), n_2 = seq(1, 100, 25),
...
bpdf_design %>% 
  ...
  summarize(
    prop_hbp = survey_ratio(sys_over_140, n(), na.rm = TRUE, vartype = "ci")
  )
```
