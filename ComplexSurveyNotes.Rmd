...
of being sampled. If that is the house that is chosen its weight needs to go
from 2 to $\frac{5}{7}$ to better reflect its sampling probability. In a real
sample this would be corrected relative to all the other households number of
telephones or perhaps a population average of the number of telephones.
