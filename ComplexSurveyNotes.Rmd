...
nhanes <- dbGetQuery(dbcon, "select SDPPSU6, WTPFQX6, SDPSTRA6,
                     ...
                     DMPCREGN, BMPWTMI, BMPWTIF, BDPFNDMI, BDPFNDIF from set1")
...
As I alluded to above, typically multiple imputed datasets are provided
...
idenifying that the variability between $m$ imputed datasets represents the 
