...
```{r q_3_9_pps_stderrs, eval = FALSE}
estimated_stderrs <- as_tibble(t(rowMeans(total_sims[, 2, ]))) %>%
  mutate(label = "Estimate")
...
function  density function, a histogram and a boxplot of total household income.
