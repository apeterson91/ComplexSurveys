...
prop_contained <- rowMeans((total_sims[,3,] < totals & total_sims[,4,] > totals) * 1)
prop_contained 
```
...
The strata would be the cross sectional


3.4  The British Household Panel Survey is documented at 
...
3.11 Since 1999, NHANES has been conducting suveys continuously with data 
